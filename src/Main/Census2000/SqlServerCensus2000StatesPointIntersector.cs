...
namespace TAMU.GeoInnovation.PointIntersectors.Census.SqlServer.Census2000
{
    [Serializable]
    public class SqlServerCensus2000StatesPointIntersector : AbstractCensus2000StatesPointIntersector
    {
        ...
        public SqlServerCensus2000StatesPointIntersector()
            : base()
        { }

        public SqlServerCensus2000StatesPointIntersector(double version, IQueryManager blockFilesQueryManager, IQueryManager stateFilesQueryManager, IQueryManager countryFilesQueryManager)
