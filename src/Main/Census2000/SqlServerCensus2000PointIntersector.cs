...
{
    [Serializable]
    public class SqlServerCensus2000PointIntersector : AbstractCensus2000PointIntersector
    {
        ...
        public SqlServerCensus2000PointIntersector()
            : base()
        { }

        public SqlServerCensus2000PointIntersector(double version, IQueryManager blockFilesQueryManager, IQueryManager stateFilesQueryManager, IQueryManager countryFilesQueryManager)
