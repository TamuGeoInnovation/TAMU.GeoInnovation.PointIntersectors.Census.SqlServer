...
{
    [Serializable]
    public class SqlServerCensus2010StatesPointIntersector : AbstractCensus2010StatesPointIntersector
    {
        ...
        public SqlServerCensus2010StatesPointIntersector()
            : base()
        { }

        public SqlServerCensus2010StatesPointIntersector(double version, IQueryManager blockFilesQueryManager, IQueryManager stateFilesQueryManager, IQueryManager countryFilesQueryManager)
