...
namespace TAMU.GeoInnovation.PointIntersectors.Census.SqlServer.Census2015
{
    ...
    [Serializable]
    public class SqlServerCensus2015PointIntersector : AbstractCensus2015PointIntersector
    {
        ...
        public SqlServerCensus2015PointIntersector()
            : base()
        { }

        public SqlServerCensus2015PointIntersector(double version, IQueryManager blockFilesQueryManager, IQueryManager stateFilesQueryManager, IQueryManager countryFilesQueryManager)
        ...
        public override string GetCBSAMicroFips(string cbsaFp)
        {
            ...
            try
            {
                ...
                sql += "  LSAD10 ";
                sql += " FROM ";
                //sql += " [Census2015CountryFiles].[dbo]." + "us_cbsa10 ";
                sql += "us_cbsa10 ";
                sql += " WHERE ";
                sql += "  cbsaFp10=@cbsaFp";
        ...
        public override string GetMSAFipsFromPlaceFips(string stateFips, string placeFips)
        {
            ...
            try
            {
                ...
                sql += "  MSA ";
                sql += " FROM ";
                //sql += " [Census2015CountryFiles].[dbo]." + "MetropolitanStatisticalAreas10 ";
